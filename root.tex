...
Em que $T_p$ são as imagens de busca corretas e $N_q = T_p + F_p + F_N + T_N$ são todas as imagens de busca. Quando o recall é igual a $100\%$, $R@N$ assumi a mesma forma da equação de precisão. Essa métrica tem origem de \textit{information retrieval}~\cite{if1}, usada em~\cite{ann1}.
